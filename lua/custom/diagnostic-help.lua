...
function M.setup()
    ...
    set("n", "<leader>de", function()
        toggle_diagnostic_type "error"
    end, { desc = "Toggle error diagnostics" })
    set("n", "<leader>dw", function()
        toggle_diagnostic_type "warn"
    end, { desc = "Toggle warning diagnostics" })
    set("n", "<leader>di", function()
        toggle_diagnostic_type "info"
    end, { desc = "Toggle info diagnostics" })
    set("n", "<leader>dh", function()
        toggle_diagnostic_type "hint"
    ...
    set("n", "<leader>ds", function()
        ...
        vim.notify(
            "Diagnostic signs " .. (vim.diagnostic.config().signs and "enabled" or "disabled"),
            vim.log.levels.INFO
        )
    ...
    set("n", "<leader>du", function()
        ...
        vim.notify(
            "Diagnostic underlines " .. (vim.diagnostic.config().underline and "enabled" or "disabled"),
            vim.log.levels.INFO
        )
    ...
    set("n", "<leader>dv", function()
        ...
        vim.notify(
            "Diagnostic virtual text " .. (vim.diagnostic.config().virtual_text and "enabled" or "disabled"),
            vim.log.levels.INFO
        )
